...
// Simple Icons v13.21.0, CC0-1.0. Kept locally: no icon fonts or external requests.
// Source: https://github.com/simple-icons/simple-icons/tree/13.21.0/icons
const paths = {
...
function BrandIcon({ brand, size = 18, ...props }: BrandIconProps & { brand: keyof typeof paths }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} viewBox="0 0 24 24"
      fill="currentColor" aria-hidden="true" focusable="false" data-brand={brand} {...props}>
      <path d={paths[brand]} />
    </svg>
  );
}
...
export function UpworkIcon(props: BrandIconProps) {
  return <BrandIcon brand="upwork" {...props} />;
}
